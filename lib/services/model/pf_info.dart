...
/// * [maritalStatusList] - Lista (opzionale) dello storico degli stati civili.
/// * [addressList] - Lista (opzionale) dello storico degli indirizzi.
/// * [citizenshipList] - Lista (opzionale) dello storico delle cittadinanze.
@BuiltValue()
abstract class PfInfo implements Built<PfInfo, PfInfoBuilder> {
  ...
  /// Lista (opzionale) dello storico degli stati civili.
  @BuiltValueField(wireName: r'marital_status_list')
  BuiltList<MaritalStatus>? get maritalStatusList;

  /// Lista (opzionale) dello storico degli indirizzi.
  @BuiltValueField(wireName: r'address_list')
  BuiltList<Address>? get addressList;

  /// Lista (opzionale) dello storico delle cittadinanze.
  @BuiltValueField(wireName: r'citizenship_list')
  BuiltList<Citizenship>? get citizenshipList;

  PfInfo._();

  factory PfInfo([void updates(PfInfoBuilder b)]) = _$PfInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PfInfoBuilder b) => b..birthNationId = 'ITA';

  @BuiltValueSerializer(custom: true)
  static Serializer<PfInfo> get serializer => _$PfInfoSerializer();
}

class _$PfInfoSerializer implements PrimitiveSerializer<PfInfo> {
  @override
  final Iterable<Type> types = const [PfInfo, _$PfInfo];

  @override
  final String wireName = r'PfInfo';
